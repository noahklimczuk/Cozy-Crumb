    ...
    private var cookingCard: some View {
        SettingsCard(
            ...
            CozySegmentedControl(
                label: "Units",
                options: MeasurementSystem.allCases.map { CozySegment(value: $0.rawValue, title: $0.displayName) },
    ...
    private var appearanceCard: some View {
        SettingsCard(title: "Look and feel") {
            ...
            VStack(alignment: .leading, spacing: CozySpacing.s) {
                ...
                CozySegmentedControl(
                    label: "Appearance",
                    options: AppAppearance.allCases.map { CozySegment(value: $0, title: $0.displayName) },
